export function ReservationForm() {
  return (
    <div className="border-2 border-[#c5a075] p-8 rounded-lg">
      <div className="mb-6">
      ...
      <a href="/contact"><button className="w-full bg-[#c5a075] text-white py-4 font-bold hover:bg-[#b08e68] transition-all transform hover:scale-105">
        RESERVE NOW
      </button></a>
    </div>
  );
